...
[Anaconda3-2023.07-2-Windows-x86_64.exe](https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Anaconda3-2023.07-2-Windows-x86_64.exe)

1. 对于Mac系统(采用M系列处理器)：

[Anaconda3-2023.07-2-MacOSX-arm64.pkg)](https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Anaconda3-2023.07-2-MacOSX-arm64.pkg)

1. 对于Mac系统(采用Intel处理器)：

[Anaconda3-2023.07-2-MacOSX-x86_64.pkg](https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Anaconda3-2023.07-2-MacOSX-x86_64.pkg)
...
3. `Jupyter`：我们后面要用到的Jupyter插件，一般已经包括在Python插件中，如果已经存在不用再安装。
